...
Recovered WYMeditor http://www.wymeditor.org/ which had been repaced in spree version with YUIEditor. WYM isn't perfect, but site admins
should concentrate on content, and not be setting inline font styles and so on, that belongs in the CSS.
